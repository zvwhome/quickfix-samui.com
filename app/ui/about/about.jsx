      ...
      <div className={styles.wrap}>
        <div className={styles.descriptionSection}>
          ...
          <p className={styles.descriptionContent}>
            ...
            experience in Germany, which now also offers services relating to
          ...
          <p className={styles.descriptionContent}>
            ...
            trades from a single source, regardless of whether it is just a
            small repair, a renovation or a larger project. You can reach us
            quickly and easily via phone, WhatsApp, line or email and make an
            appointment for your concern. Thanks to our flexible and
            well-structured setup, we guarantee that we will be on site within 2
            hours to get an impression of the work to be done.
          </p>
          <p className={styles.descriptionContent}>
          ...
          <p className={styles.descriptionContent}>
            We would also like to help you with your upcoming projects related
            to your home - no matter the extent. Simply contact us in the
            easiest way possible for you. Our friendly and experienced team will
